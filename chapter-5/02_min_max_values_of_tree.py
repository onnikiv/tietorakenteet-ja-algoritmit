...
class Tree():
    ...
    def find_minimum(self):
        ...
        # BST puussa pienin on aina vasemmaisimmassa nodessa
        # nuuhkitaan kaikki vasenmanpuoleiset nodet kunnes seuraava on tyhjä
        if self._root_node:
            current = self._root_node
    ...
    def find_maximum(self):
        ...
        """
        # Samaten BST puussa suurin on aina oikeinmaisimmassa nodess
        # nuuhkitaan kaikki oikeanpuoleiset nodet kunnes seuraava on tyhjä
        if self._root_node:
            current = self._root_node
