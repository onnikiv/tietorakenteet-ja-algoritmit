...
class IntArray():
    ...
    def insert(self, index:int, val:int) -> None:
        ...
        if self._resmem:
            ...
            # Kopioidaan alkiot indexin jälkeen
        ...
        self._resmem = new_resmem
        # asetetaan tyhjään arvoon haluttu arvo
